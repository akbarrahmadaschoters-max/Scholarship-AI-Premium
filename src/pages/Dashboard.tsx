        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-5">
            ...
            <button 
              ...
              className="h-10 w-10 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-700 font-bold border-2 border-white shadow-sm ring-2 ring-indigo-50 hover:bg-indigo-100 hover:ring-indigo-100 transition-all cursor-pointer"
              title="Edit Scholarship Profile"
            >
              {currentUser?.displayName?.charAt(0) || 'U'}
            </button>
            <Button variant="ghost" size="sm" onClick={handleLogout} className="font-semibold text-slate-500">
              Logout
            </Button>
          </div>
        </div>
